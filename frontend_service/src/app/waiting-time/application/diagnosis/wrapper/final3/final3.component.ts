...
@Component({
	selector: 'app-final',
	templateUrl: './final3.component.html',
	styleUrls: ['./final3.component.css']
})
export class Final3Component implements OnInit, OnDestroy {
	...
	ngOnDestroy() {
		this.dataService.answers_yellow = this.answers_red;
